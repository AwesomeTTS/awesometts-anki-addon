...
config = Config(
    ...
    cols=[
        ...
        ('launch_browser_generator', 'integer',aqt.qt.Qt.KeyboardModifier.ControlModifier |aqt.qt.Qt.Key_T,
         to.nullable_key, to.nullable_int),
        ('launch_browser_stripper', 'integer', None, to.nullable_key,
         to.nullable_int),
        ('launch_configurator', 'integer',aqt.qt.Qt.KeyboardModifier.ControlModifier |aqt.qt.Qt.Key_T,
         to.nullable_key, to.nullable_int),
        ('launch_editor_generator', 'integer',aqt.qt.Qt.KeyboardModifier.ControlModifier |aqt.qt.Qt.Key_T,
         to.nullable_key, to.nullable_int),
        ('launch_templater', 'integer',aqt.qt.Qt.KeyboardModifier.ControlModifier |aqt.qt.Qt.Key_T,
         to.nullable_key, to.nullable_int),
