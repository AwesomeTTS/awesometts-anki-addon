...
class BrowserStripper(Dialog):
    ...
    def _ui(self):
        ...
        for value, label in [
            ...
            radio = aqt.qt.QRadioButton(label)
    ...
    def _ui_buttons(self):
        ...
        buttons.findChild(aqt.qt.QAbstractButton, 'okay').setText("&Remove Now")
    ...
    def show(self, *args, **kwargs):
        ...
        panel = aqt.qt.QWidget()
        panel.setLayout(layout)

        self.findChild(aqt.qt.QScrollArea, 'scroll').setWidget(panel)
        ...
        (
            ...
            or self.findChild(aqt.qt.QRadioButton)  # use first if config bad
        ).setChecked(True)
    ...
    def _accept_process(self, fields):
        ...
        mode = next(
            radio.objectName()
            for radio in self.findChildren(aqt.qt.QRadioButton)
            if radio.isChecked()
        )
