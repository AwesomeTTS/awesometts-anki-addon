...
class GoogleTTS(Service):
    ...
    _voice_list = [
        ...
        ("en-GB-Standard-F", "English, United Kingdom (en-GB-Standard-F)"),
        ...
        ("en-GB-Wavenet-F", "English, United Kingdom (en-GB-Wavenet-F)"),
        ...
        ("en-US-Standard-G", "English, United States (en-US-Standard-G)"),
        ("en-US-Standard-H", "English, United States (en-US-Standard-H)"),
        ("en-US-Standard-I", "English, United States (en-US-Standard-I)"),
        ("en-US-Standard-J", "English, United States (en-US-Standard-J)"),
        ...
        ("en-US-Wavenet-G", "English, United States (en-US-Wavenet-G)"),
        ("en-US-Wavenet-H", "English, United States (en-US-Wavenet-H)"),
        ("en-US-Wavenet-I", "English, United States (en-US-Wavenet-I)"),
        ("en-US-Wavenet-J", "English, United States (en-US-Wavenet-J)"),
        ("es-ES-Standard-A", "Spanish (es-ES-Standard-A)"),
        ("es-ES-Standard-B", "Spanish (es-ES-Standard-B)"),
        ...
        ("ro-RO-Standard-A", "Romanian (ro-RO-Standard-A)"),
        ...
        ("yue-HK-Standard-A", "Yue Chinese (yue-HK-Standard-A)"),
        ("yue-HK-Standard-B", "Yue Chinese (yue-HK-Standard-B)"),
        ("yue-HK-Standard-C", "Yue Chinese (yue-HK-Standard-C)"),
        ("yue-HK-Standard-D", "Yue Chinese (yue-HK-Standard-D)"),
    ]
